...
```{r cran, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r cran2, warning=FALSE, message=FALSE, fig.width=13, fig.height=7}
library(ggplot2)
...
Osa tämän blogipostauksen [taustakoodista](https://github.com/louhos/louhos.github.com/blob/master/_R/2014-06-07-uusiblogi.Rmd) on piilotettu tekstin
pitämiseksi selkeänä. Koko postauksen, R-koodit ja kuvat mukaan
